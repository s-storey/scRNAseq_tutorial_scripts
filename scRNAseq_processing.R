...
# paste the path here
data_dir <- "your/path/to/filtered_gene_bc_matrices/hg19"
...
qc_subset <- subset(sc_object, subset = nFeature_RNA > 200 & nFeature_RNA < 2500 & percent.mt < 5)
...
saveRDS(sc_object, file = "sc_object.rds")

# Later, you can load it with:
sc_objectpost_qc <- readRDS("sc_object.rds")
